...
>;
export const onCreateComicPageId = /* GraphQL */ `subscription OnCreateComicPageId(
  $filter: ModelSubscriptionComicPageIdFilterInput
) {
  onCreateComicPageId(filter: $filter) {
    id
    pageId
    updatedAt
    createdAt
...
` as GeneratedSubscription<
  APITypes.OnCreateComicPageIdSubscriptionVariables,
  APITypes.OnCreateComicPageIdSubscription
>;
export const onUpdateComicPageId = /* GraphQL */ `subscription OnUpdateComicPageId(
  $filter: ModelSubscriptionComicPageIdFilterInput
) {
  onUpdateComicPageId(filter: $filter) {
    id
    pageId
    updatedAt
    createdAt
...
` as GeneratedSubscription<
  APITypes.OnUpdateComicPageIdSubscriptionVariables,
  APITypes.OnUpdateComicPageIdSubscription
>;
export const onDeleteComicPageId = /* GraphQL */ `subscription OnDeleteComicPageId(
  $filter: ModelSubscriptionComicPageIdFilterInput
) {
  onDeleteComicPageId(filter: $filter) {
    id
    pageId
    updatedAt
    createdAt
...
` as GeneratedSubscription<
  APITypes.OnDeleteComicPageIdSubscriptionVariables,
  APITypes.OnDeleteComicPageIdSubscription
>;
