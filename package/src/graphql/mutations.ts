...
>;
export const createComicPageId = /* GraphQL */ `mutation CreateComicPageId(
  $input: CreateComicPageIdInput!
  $condition: ModelComicPageIdConditionInput
) {
  createComicPageId(input: $input, condition: $condition) {
    id
    pageId
    updatedAt
    createdAt
...
` as GeneratedMutation<
  APITypes.CreateComicPageIdMutationVariables,
  APITypes.CreateComicPageIdMutation
>;
export const updateComicPageId = /* GraphQL */ `mutation UpdateComicPageId(
  $input: UpdateComicPageIdInput!
  $condition: ModelComicPageIdConditionInput
) {
  updateComicPageId(input: $input, condition: $condition) {
    id
    pageId
    updatedAt
    createdAt
...
` as GeneratedMutation<
  APITypes.UpdateComicPageIdMutationVariables,
  APITypes.UpdateComicPageIdMutation
>;
export const deleteComicPageId = /* GraphQL */ `mutation DeleteComicPageId(
  $input: DeleteComicPageIdInput!
  $condition: ModelComicPageIdConditionInput
) {
  deleteComicPageId(input: $input, condition: $condition) {
    id
    pageId
    updatedAt
    createdAt
...
` as GeneratedMutation<
  APITypes.DeleteComicPageIdMutationVariables,
  APITypes.DeleteComicPageIdMutation
>;
