...
import { createComicEngagement } from "../graphql/mutations";
const client = generateClient();
export default function ComicEngagementCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setComicId(initialValues.comicId);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createComicEngagement.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ComicEngagementCreateForm")}
      {...rest}
    >
      <TextField
        label="Comic id"
