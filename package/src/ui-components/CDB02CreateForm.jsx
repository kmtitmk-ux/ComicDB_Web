...
import { createCDB02 } from "../graphql/mutations";
const client = generateClient();
export default function CDB02CreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCDB02.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CDB02CreateForm")}
      {...rest}
    >
      <TextField
        label="Post id"
