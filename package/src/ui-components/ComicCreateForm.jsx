...
export default function ComicCreateForm(props) {
  ...
  const resetStateValues = () => {
    setAddLike(initialValues.addLike);
    setCreatedAt(initialValues.createdAt);
    setDescription(initialValues.description);
    setErrorCount(initialValues.errorCount);
    setImg(initialValues.img);
    setLike(initialValues.like);
    setStatus(initialValues.status);
    setTags(initialValues.tags);
    setTitle(initialValues.title);
    setOfficialTitle(initialValues.officialTitle);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createComic.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
