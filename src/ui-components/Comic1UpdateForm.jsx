...
export default function Comic1UpdateForm(props) {
  const {
    id: idProp,
    comic1: comic1ModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = comic1Record
      ? { ...initialValues, ...comic1Record }
      : initialValues;
  ...
  const [comic1Record, setComic1Record] = React.useState(comic1ModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Comic1, idProp)
        : comic1ModelProp;
      setComic1Record(record);
    };
    queryData();
  }, [idProp, comic1ModelProp]);
  React.useEffect(resetStateValues, [comic1Record]);
  const validations = {
    createdAt: [],
    url: [],
    title: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Comic1.copyOf(comic1Record, (updated) => {
      ...
      {...getOverrideProps(overrides, "Comic1UpdateForm")}
      {...rest}
    >
      <TextField
        label="Created at"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || comic1ModelProp)}
